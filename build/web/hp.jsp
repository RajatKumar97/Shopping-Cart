				...
				<div id="header">
					...
					<h1 id="logo"><a title="Home" href="#">Electronics store</a></h1>
                                         <% if(session.getAttribute("email")!=null)
                                                                                       {
                                            %>
                                            <form><p class="shopping-cart"><a class="cart" href="#" title="Your Shopping Cart">Your Shopping Cart</a><span>Name :<%=session.getAttribute("name")%> </span>&nbsp;					
...
%>					
 ...
 try
   ...
   rs=stmt.executeQuery("select * from image  where brand='"+request.getParameter("qc") +"' ");
