...
public final class pendrives_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <html>\n");
      out.write("<head>\n");
      out.write("<title>Creating jQuery Popup</title>\n");
 ...
 try
   ...
   rs=stmt.executeQuery("select * from image where category='pendrive' ");
   ...
   while(rs.next())
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"cl\"></div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<form>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"field-holder\"><input type=\"email\" name=\"c1\" class=\"field\" value=\"Your Email\" title=\"Your Email\" /></div>\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"field-holder\"><input type=\"text\" name=\"c2\" class=\"field\" value=\"Your Name\" title=\"Your Name\" /></div>\n");
 ...
 try
    ...
    rs1=stmt1.executeQuery("select max(id) from contactus");
    if(rs1.next())
               {
        id=rs1.getString(1);
    }
   ...
   stmt1.executeUpdate("insert into contactus values("+(idd+1)+",'"+request.getParameter("c1")+"','"+request.getParameter("c2")+"')");
